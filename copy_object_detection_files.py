...
def copy_object_detection_json(src_dir, dst_dir):
    ...
    for root, dirs, files in os.walk(src_dir):
        ...
        if "knife_object_detection.json" in files:
            # Get the name of the folder (last part of the path)
            folder_name = os.path.basename(root)

            # Construct the full path to the source file
            src_file = os.path.join(root, "knife_object_detection.json")
...
source_directory = "/home/ubuntu/projects/owl-vit-object-detection-evaluation/data/300_videos_frame_samples"
destination_directory = (
    "/home/ubuntu/projects/owl-vit-object-detection-evaluation/data/json/object_detection_300_knife_json"
)
